...
public class Ocean implements OceanInterface {
	 ...
	 * to place the larger ships. As per specification, we need 1 Battleship, 2
	 * Cruisers, 3 Destroyers, and 4 Submarines.
	 * 
	 * @see java.util.Random
	 */
	public void placeAllShipsRandomly() {
		Ship[] myShips = { new Battleship(), new Cruiser(), new Cruiser(), new Destroyer(), new Destroyer(),
